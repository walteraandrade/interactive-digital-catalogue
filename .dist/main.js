...
var H = (e2, t2) => {
  ...
  switch (t2.type) {
    ...
    case 3:
      let { toastId: a2 } = t2;
      return { ...e2, toasts: e2.toasts.map((r) => r.id === a2 || a2 === undefined ? { ...r, dismissed: true, visible: false } : r) };
    case 4:
      return t2.toastId === undefined ? { ...e2, toasts: [] } : { ...e2, toasts: e2.toasts.filter((r) => r.id !== t2.toastId) };
    case 5:
      return { ...e2, pausedAt: t2.time };
    case 6:
      let i2 = t2.time - (e2.pausedAt || 0);
      return { ...e2, pausedAt: undefined, toasts: e2.toasts.map((r) => ({ ...r, pauseDuration: r.pauseDuration + i2 })) };
  }
};
var v = [];
var j2 = { toasts: [], pausedAt: undefined, settings: { toastLimit: re } };
var f2 = {};
var Y = (e2, t2 = k) => {
...
var se = { blank: 4000, error: 4000, success: 2000, loading: 1 / 0, custom: 4000 };
var V = (e2 = {}, t2 = k) => {
  let [o2, s2] = import_react.useState(f2[t2] || j2), a2 = import_react.useRef(f2[t2]);
  import_react.useEffect(() => (a2.current !== f2[t2] && s2(f2[t2]), v.push([t2, s2]), () => {
    let r = v.findIndex(([l2]) => l2 === t2);
    r > -1 && v.splice(r, 1);
  }), [t2]);
  let i2 = o2.toasts.map((r) => {
    var l2, g2, T;
    return { ...e2, ...e2[r.type], ...r, removeDelay: r.removeDelay || ((l2 = e2[r.type]) == null ? undefined : l2.removeDelay) || (e2 == null ? undefined : e2.removeDelay), duration: r.duration || ((g2 = e2[r.type]) == null ? undefined : g2.duration) || (e2 == null ? undefined : e2.duration) || se[r.type], style: { ...e2.style, ...(T = e2[r.type]) == null ? undefined : T.style, ...r.style } };
  });
  return { ...o2, toasts: i2 };
};
var ie = (e2, t2 = "blank", o2) => ({ createdAt: Date.now(), visible: true, dismissed: false, type: t2, ariaProps: { role: "status", "aria-live": "polite" }, message: e2, pauseDuration: 0, ...o2, id: (o2 == null ? undefined : o2.id) || W() });
var P = (e2) => (t2, o2) => {
  let s2 = ie(t2, e2, o2);
...
n2.dismissAll = (e2) => n2.dismiss(undefined, e2);
n2.remove = (e2, t2) => {
  let o2 = { type: 4, toastId: e2 };
  t2 ? S(t2)(o2) : _(o2);
};
n2.removeAll = (e2) => n2.remove(undefined, e2);
n2.promise = (e2, t2, o2) => {
  let s2 = n2.loading(t2.loading, { ...o2, ...o2 == null ? undefined : o2.loading });
  return typeof e2 == "function" && (e2 = e2()), e2.then((a2) => {
    let i2 = t2.success ? h2(t2.success, a2) : undefined;
    return i2 ? n2.success(i2, { id: s2, ...o2, ...o2 == null ? undefined : o2.success }) : n2.dismiss(s2), a2;
  }).catch((a2) => {
    let i2 = t2.error ? h2(t2.error, a2) : undefined;
    i2 ? n2.error(i2, { id: s2, ...o2, ...o2 == null ? undefined : o2.error }) : n2.dismiss(s2);
  }), e2;
};
var ce = 1000;
var w = (e2, t2 = "default") => {
  let { toasts: o2, pausedAt: s2 } = V(e2, t2), a2 = import_react2.useRef(new Map).current, i2 = import_react2.useCallback((c2, m2 = ce) => {
    if (a2.has(c2))
      return;
    let p2 = setTimeout(() => {
  ...
  let r = import_react2.useCallback(S(t2), [t2]), l2 = import_react2.useCallback(() => {
    r({ type: 5, time: Date.now() });
  }, [r]), g2 = import_react2.useCallback((c2, m2) => {
    r({ type: 1, toast: { id: c2, height: m2 } });
  }, [r]), T = import_react2.useCallback(() => {
    s2 && r({ type: 6, time: Date.now() });
  }, [s2, r]), d2 = import_react2.useCallback((c2, m2) => {
...
var $ = ({ toast: e2 }) => {
  ...
  return t2 !== undefined ? typeof t2 == "string" ? b2.createElement(Pe, null, t2) : t2 : o2 === "blank" ? null : b2.createElement(Se, null, b2.createElement(F, { ...s2 }), o2 !== "loading" && b2.createElement(be, null, o2 === "error" ? b2.createElement(C, { ...s2 }) : b2.createElement(L, { ...s2 })));
};
var Re = (e2) => `
...
var Me = (e2, t2) => {
  ...
  return { left: 0, right: 0, display: "flex", position: "absolute", transition: E() ? undefined : "all 230ms cubic-bezier(.21,1.02,.73,1)", transform: `translateY(${t2 * (o2 ? 1 : -1)}px)`, ...s2, ...a2 };
};
var Ce = u`
  z-index: 9999;
  > * {
...
var useCartStore = create()(persist((set, get) => ({
  ...
  addItem: (product) => {
    set((state) => {
      ...
      if (existingItem) {
        return {
          items: state.items.map((item) => item.code === product.code ? { ...item, quantity: item.quantity + 1 } : item)
        };
      }
      return {
  ...
  updateQuantity: (code, quantity) => {
    ...
    set((state) => ({
      items: state.items.map((item) => item.code === code ? { ...item, quantity } : item)
    }));
  },
  ...
  getWhatsAppMessage: () => {
    ...
    if (items.length === 0)
      return "";
    const itemsList = items.map((item) => `• ${item.name}\\n` + `  Ø${item.diameter} × ${item.length}mm - ${item.surface}\\n` + `  Código: ${item.code} | Qty: ${item.quantity}`).join("\\n\\n");
    return encodeURIComponent(`Olá! Gostaria de fazer o seguinte pedido:\\n\\n${itemsList}\\n\\n` + `Total de itens: ${get().getTotalItems()}\\n\\n` + `Aguardo retorno com disponibilidade e valores.\\n\\nObrigado!`);
  }
}), {
  name: "dental-cart-storage",
  partialize: (state) => ({ items: state.items }),
  onRehydrateStorage: () => (_2, error) => {
    if (error) {
      console.error("Cart rehydration failed:", error);
    }
  }
}));
var cart_store_default = useCartStore;

// src/utils/constants.ts
var WHATSAPP_NUMBER = import.meta.env.VITE_WHATSAPP_NUMBER || "5511999999999";
var APP_NAME = "Catálogo Interativo";
...
var Header = () => {
  const { toggleCart, getTotalItems } = cart_store_default();
        ...
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            ...
            children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h1", {
              className: "text-xl font-bold text-dental-blue",
              children: APP_NAME
          ...
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
            ...
            children: [
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV(CartIcon, {
                className: "w-6 h-6"
              }, undefined, false, undefined, this),
              totalItems > 0 && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
                className: "absolute -top-1 -right-1 bg-primary-500 text-white text-xs font-medium rounded-full h-5 w-5 flex items-center justify-center animate-fade-in",
...
var CartIcon = ({ className }) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("svg", {
  className,
  fill: "none",
  stroke: "currentColor",
  viewBox: "0 0 24 24",
...
// src/components/product/interactive-catalog.tsx
var import_react6 = __toESM(require_react(), 1);

// src/components/product/hotspot.tsx
...
var generateCode = (surface, diameter, length) => {
  if (surface === "short") {
    if (diameter === "3.75" && length === "6.5")
      return "580760";
    if (diameter === "4.3" && length === "5.5")
      return "568455";
  }
  ...
  if (length === "8.5") {
    ...
    if (length === "10")
      ...
      lengthCode = (parseFloat(length) * 10).toString().padStart(3, "0");
  }
...
var Hotspot = ({
  ...
  const [isHovered, setIsHovered] = import_react4.useState(false);
  const addItem = cart_store_default((state) => state.addItem);
  const productData = generateProductCodes().find((p2) => p2.code === code);
  if (!productData) {
  ...
  const handleClick = (e2) => {
    ...
    e2.stopPropagation();
    addItem(productData);
    n2.success(`${productData.name} adicionado ao carrinho!`, {
      duration: 2000,
  ...
  return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("button", {
    ...
    children: [
      showIcon && /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
        className: "hotspot-icon h-[8px]",
        children: /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
          className: "text-white p-2 shadow-lg transform transition-transform hover:scale-110",
          children: /* @__PURE__ */ jsx_dev_runtime2.jsxDEV(PlusIcon, {}, undefined, false, undefined, this)
        }, undefined, false, undefined, this)
      }, undefined, false, undefined, this),
      isHovered && /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
        className: "hotspot-tooltip absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 z-20",
        children: /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
          className: "bg-gray-900 text-white text-sm rounded-lg px-3 py-2 shadow-lg whitespace-nowrap",
          children: [
...
var PlusIcon = ({ className }) => /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("svg", {
  className,
  fill: "none",
  stroke: "currentColor",
  viewBox: "0 0 24 24",
...
var getHotspotsForProduct = (productId) => {
...
var use_responsive_default = useResponsive;

// src/components/product/interactive-catalog.tsx
var jsx_dev_runtime3 = __toESM(require_jsx_dev_runtime(), 1);
var InteractiveCatalog = ({ productId = "implante-torq" }) => {
  const [imageLoaded, setImageLoaded] = import_react6.useState(false);
  const imageRef = import_react6.useRef(null);
  const { isMobile } = use_responsive_default();
  ...
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
    className: "interactive-catalog relative",
    children: [
      !imageLoaded && /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
      ...
      /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
        ...
        children: [
          ...
          imageLoaded && /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
            className: "hotspot-overlay absolute inset-0",
            children: hotspots.map((hotspot) => /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(hotspot_default, {
              code: hotspot.code,
              position: hotspot.position,
              showIcon: isMobile
            }, hotspot.code, false, undefined, this))
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this)
    ]
...
var interactive_catalog_default = InteractiveCatalog;
...
var CartItemComponent = ({ item }) => {
  const { updateQuantity, removeItem } = cart_store_default();
  ...
  return /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("div", {
    className: "cart-item bg-white border border-gray-200 rounded-lg p-4",
    children: [
      /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("div", {
            className: "flex-1",
            children: [
              /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("h4", {
          ...
          /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("button", {
            ...
            children: /* @__PURE__ */ jsx_dev_runtime4.jsxDEV(TrashIcon, {
              className: "w-4 h-4"
            }, undefined, false, undefined, this)
          }, undefined, false, undefined, this)
        ]
          ...
          /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("div", {
            ...
            children: [
              /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("button", {
                ...
                children: /* @__PURE__ */ jsx_dev_runtime4.jsxDEV(MinusIcon, {
                  className: "w-4 h-4"
                }, undefined, false, undefined, this)
              }, undefined, false, undefined, this),
              ...
              /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("button", {
                ...
                children: /* @__PURE__ */ jsx_dev_runtime4.jsxDEV(PlusIcon2, {
                  className: "w-4 h-4"
                }, undefined, false, undefined, this)
              }, undefined, false, undefined, this)
            ]
...
var TrashIcon = ({ className }) => /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("svg", {
  className,
  fill: "none",
  stroke: "currentColor",
  viewBox: "0 0 24 24",
...
var MinusIcon = ({ className }) => /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("svg", {
  className,
  fill: "none",
  stroke: "currentColor",
  viewBox: "0 0 24 24",
...
var PlusIcon2 = ({ className }) => /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("svg", {
  className,
  fill: "none",
  stroke: "currentColor",
  viewBox: "0 0 24 24",
...
var cart_item_default = CartItemComponent;

// src/utils/whatsapp.ts
var openWhatsApp = (message) => {
  if (!message) {
...
// src/components/cart/whatsapp-button.tsx
var jsx_dev_runtime5 = __toESM(require_jsx_dev_runtime(), 1);
var WhatsAppButton = () => {
  const { items, getWhatsAppMessage } = cart_store_default();
  ...
  return /* @__PURE__ */ jsx_dev_runtime5.jsxDEV("button", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime5.jsxDEV(WhatsAppIcon, {
        className: "w-5 h-5"
      }, undefined, false, undefined, this),
...
var WhatsAppIcon = ({ className }) => /* @__PURE__ */ jsx_dev_runtime5.jsxDEV("svg", {
  className,
  viewBox: "0 0 24 24",
  fill: "currentColor",
...
var whatsapp_button_default = WhatsAppButton;

// src/components/cart/cart-sidebar.tsx
var jsx_dev_runtime6 = __toESM(require_jsx_dev_runtime(), 1);
var CartSidebar = () => {
  const { items, isCartOpen, closeCart, getTotalItems } = cart_store_default();
  import_react7.useEffect(() => {
    const handleEscape = (e2) => {
      if (e2.key === "Escape" && isCartOpen) {
        closeCart();
      }
    };
  ...
  return /* @__PURE__ */ jsx_dev_runtime6.jsxDEV(jsx_dev_runtime6.Fragment, {
    children: [
      isCartOpen && /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
      ...
      `,
        children: [
          /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
            className: "cart-header flex items-center justify-between p-4 border-b",
            children: [
              ...
              /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("button", {
                ...
                children: /* @__PURE__ */ jsx_dev_runtime6.jsxDEV(XIcon, {
          ...
          /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
            className: "cart-content flex-1 overflow-y-auto",
            children: items.length === 0 ? /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
              className: "empty-cart flex flex-col items-center justify-center h-full p-8 text-center",
              children: [
                /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
                  className: "w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4",
                  children: /* @__PURE__ */ jsx_dev_runtime6.jsxDEV(ShoppingCartIcon, {
                ...
                /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("p", {
                  ...
                  children: "Clique nos produtos do catálogo para adicioná-los ao carrinho."
                }, undefined, false, undefined, this)
              ]
            }, undefined, true, undefined, this) : /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
              className: "cart-items space-y-4 p-4",
              children: items.map((item) => /* @__PURE__ */ jsx_dev_runtime6.jsxDEV(cart_item_default, {
                item
              }, item.code, false, undefined, this))
            }, undefined, false, undefined, this)
          }, undefined, false, undefined, this),
          items.length > 0 && /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
            className: "cart-footer border-t p-4 space-y-4",
            children: [
              /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
              ...
              /* @__PURE__ */ jsx_dev_runtime6.jsxDEV(whatsapp_button_default, {}, undefined, false, undefined, this),
              /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("button", {
                onClick: () => cart_store_default.getState().clearCart(),
...
var XIcon = ({ className }) => /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("svg", {
  className,
  fill: "none",
  stroke: "currentColor",
  viewBox: "0 0 24 24",
...
var ShoppingCartIcon = ({ className }) => /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("svg", {
  className,
  fill: "none",
  stroke: "currentColor",
  viewBox: "0 0 24 24",
...
var cart_sidebar_default = CartSidebar;
...
function App() {
  return /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("div", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime7.jsxDEV(header_default, {}, undefined, false, undefined, this),
          ...
          /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("div", {
            ...
            children: [
              /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("h2", {
                ...
                children: "Catálogo Interativo de Implantes"
              }, undefined, false, undefined, this),
              /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("p", {
                className: "text-lg text-gray-600 max-w-2xl mx-auto",
                children: "Clique nos produtos das imagens para adicionar ao seu carrinho e finalize seu pedido via WhatsApp."
              }, undefined, false, undefined, this)
            ]
          }, undefined, true, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime7.jsxDEV(interactive_catalog_default, {}, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime7.jsxDEV(cart_sidebar_default, {}, undefined, false, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime7.jsxDEV(Fe, {
        position: "bottom-center",
        toastOptions: {
          duration: 2000,
          style: {
...
import_client.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsx_dev_runtime8.jsxDEV(import_react8.StrictMode, {
